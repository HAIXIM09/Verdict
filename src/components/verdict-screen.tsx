...
import { Scale, Trophy, Flame, TrendingUp, Coins, ArrowUpRight, Swords } from 'lucide-react';
      ...
      <div className="w-full max-w-lg space-y-6 relative z-10">
        ...
        <Card className="bg-zinc-800 border-zinc-800">
          <CardContent className="p-6">
            ...
            <div className="h-5 rounded-full overflow-hidden bg-zinc-800 flex">
              <div
                className="bg-red-600 bg-burn-gradient transition-all duration-1000"
                style={{ width: `${pctA}%` }}
              />
              <div
